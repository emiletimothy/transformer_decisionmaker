...
WEATHER_PROMPTS = {"interactive_weather", "interactive_weather_no_hint",
                    ...
                    "interactive_weather_notehist"}  # weather-style prompts (sunny/rainy)
...
NOTE_HISTORY_PROMPTS = {
    ...
    "interactive_weather_notehist", "interactive_online_notehist",
}
NOTE_HISTORY_WEATHER = {
    "interactive_weather_v2_notehist", "interactive_weather_no_hint_v2_notehist",
    "interactive_weather_notehist",
}
...
_NOTEHIST_TO_TEMPLATE = {
    ...
    "interactive_weather_notehist": "interactive_weather",
    "interactive_online_notehist": "interactive_online",
}
