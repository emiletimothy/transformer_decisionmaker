...
# checkpoints saved before this module was renamed (learned_mw_transformer.py) pickle their
# classes under the old module name; register it so torch.load can still find them
import sys as _sys  # noqa: E402
_sys.modules.setdefault("learned_mw_transformer", _sys.modules[__name__])
